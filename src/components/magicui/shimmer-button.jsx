  ...
  (
    ...
    return (
      <button
        ...
        className={cn(
          "group relative z-0 flex cursor-pointer items-center justify-center overflow-hidden whitespace-nowrap border px-6 py-3 text-white",
          // Apply the background and border radius based on custom CSS variables
          "[background:var(--bg)] [border-radius:var(--radius)] dark:text-black",
          // Apply the primary color from CSS variables
          "border-[var(--border)]",
